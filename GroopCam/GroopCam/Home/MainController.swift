...
//                    self.collectionView?.refreshControl?.endRefreshing()
    ...
    override func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        if (self.groups.count == 0) {
            self.collectionView.setEmptyMessage("No group albums yet! 😔 click new group to start a roll. 📸")
        } else {
...
//        }))
    ...
    func sendText() {
            if (MFMessageComposeViewController.canSendText()) {
                ...
                controller.body = "Come join me on GroopCam, a social group roll app 📸😎 https://apple.co/2S052xI"
...
//        navigationController?.navigationBar.barTintColor = Theme.lgColor
        self.navigationController?.navigationBar.topItem?.title = "Group Albums"
